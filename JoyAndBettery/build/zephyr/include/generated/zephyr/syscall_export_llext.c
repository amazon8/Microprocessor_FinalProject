...
extern __weak ALIAS_OF(no_handler) void * const z_impl_kscan_config;
extern __weak ALIAS_OF(no_handler) void * const z_impl_kscan_enable_callback;
extern __weak ALIAS_OF(no_handler) void * const z_impl_kscan_disable_callback;
